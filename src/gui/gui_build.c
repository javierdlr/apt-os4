...
//BUTTONSDOWN
         LAYOUT_AddChild, IIntuition->NewObject(LayoutClass, NULL, //"layout.gadget",
           ...
           LAYOUT_AddChild, OBJ(OID_UPDATE) = IIntuition->NewObject(ButtonClass, NULL,
             ...
             GA_RelVerify,  TRUE,
             //GA_HintInfo,   GetString(&Li, MSG_GUI_VERIFY_HELP),
             GA_Text,       "Up_date",//GetString(&Li, MSG_GUI_VERIFY),
           TAG_DONE),
           ...
           LAYOUT_AddChild, OBJ(OID_UPGRADE) = IIntuition->NewObject(ButtonClass, NULL,
             ...
             GA_RelVerify,  TRUE,
             //GA_HintInfo,   GetString(&Li, MSG_GUI_VERIFY_HELP),
             GA_Text,       "Up_grade",//GetString(&Li, MSG_GUI_VERIFY),
           TAG_DONE),
           CHILD_WeightedWidth, 0,
           ...
           TAG_DONE),
         TAG_DONE), // END of BUTTONSDOWN
         CHILD_WeightedHeight, 0,
       TAG_DONE), // END of SEARCH+LIST+BUTTONSDOWN
//BUTTONSRIGHT
       LAYOUT_AddChild, OBJ(OID_BUTTONSRIGHT_GROUP) = IIntuition->NewObject(LayoutClass, NULL, //"layout.gadget",
       LAYOUT_Orientation, LAYOUT_ORIENT_VERT,
       ...
       LAYOUT_AddChild, OBJ(OID_INSTALL) = IIntuition->NewObject(ButtonClass, NULL,
         ...
         GA_RelVerify,  TRUE,
         //GA_HintInfo,   GetString(&Li, MSG_GUI_VERIFY_HELP),
         GA_Text,       "_Install",//GetString(&Li, MSG_GUI_VERIFY),
       TAG_DONE),
       LAYOUT_AddChild, OBJ(OID_UNINSTALL) = IIntuition->NewObject(ButtonClass, NULL,
         GA_ID,         OID_UNINSTALL,
         GA_RelVerify,  TRUE,
         //GA_HintInfo,   GetString(&Li, MSG_GUI_VERIFY_HELP),
         GA_Text,       "_Uninstall",//GetString(&Li, MSG_GUI_VERIFY),
       TAG_DONE),
       LAYOUT_AddChild, IIntuition->NewObject(SpaceClass, NULL, TAG_DONE),
       LAYOUT_AddChild, OBJ(OID_REMOVE) = IIntuition->NewObject(ButtonClass, NULL,
         ...
         GA_RelVerify,  TRUE,
         //GA_HintInfo,   GetString(&Li, MSG_GUI_VERIFY_HELP),
         GA_Text,       "_Remove",//GetString(&Li, MSG_GUI_VERIFY),
        TAG_DONE),
      TAG_DONE), // END of BUTTONSRIGHT
      CHILD_WeightedWidth, 0,
      CHILD_WeightedHeight, 0,
...
IIntuition->SetAttrs(OBJ(OID_APTLIST), LISTBROWSER_Labels,gui->apt_list, TAG_DONE);


 // "Init" some gaddets
 IIntuition->SetAttrs(OBJ(OID_BUTTONSRIGHT_GROUP), GA_Disabled,TRUE, TAG_DONE);
